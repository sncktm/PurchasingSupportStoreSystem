	...
	<form class="product-form" method="post" action="AdupdateServlet"
		...
		<div class="container">
			...
			<div class="section">
                ...
                <div class="form-row">
                    <input type="text" id="ad-title" name="ad-title" value="<%= store.getAdvertisement_title() %>" required>
                </div>
    ...
    fileInput.addEventListener("change", function (event) {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                previewImage.src = e.target.result; // 新しい画像をプレビュー表示
                popupImage.src = e.target.result; // ポップアップの画像も変更
            };
...
<div class="photo-section">
    <img src="images/advertisement/<%= store.getAdvertisement_Image() %>"
         alt="広告画像" 
         id="preview-image" 
    ...
    <div class="popup-content">
        ...
        <img src="images/advertisement/<%= store.getAdvertisement_Image() %>"
            ...
            %>
						...
						<div class="right-section">
							<label class="label" for="file-upload">写真アップロード</label> <input
