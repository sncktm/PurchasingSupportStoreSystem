...
<h1 class="title">広告削除</h1>
	...
	<div class="section-title">広告の詳細</div>
		...
		<div class="content-container">
			...
			<div class="photo-section">
				<img
					src="images/advertisement/<%= store.getAdvertisement_Image() %>"
					alt="広告画像" id="photo" />
			</div>
			<!-- ポップアップ用のオーバーレイ -->
			<div id="popup" class="popup-overlay">
				<div class="popup-content">
					<span class="close-btn" id="close-btn">&times;</span> <img
						src="images/advertisement/<%= store.getAdvertisement_Image() %>"
						alt="拡大写真" id="popup-image">
				</div>
			</div>
		...
		<div class="section">
			...
			<%
			// サーブレットから受け取ったデータを取得
			java.util.List<model.AdvertisementManagementBeans> ProductArray = (java.util.List<model.AdvertisementManagementBeans>) request
					.getAttribute("ProductArray");
	...
	<div class="button-container">
		...
		<!-- 削除用フォーム -->
		<form id="deleteForm" action="DeleteAdvertiseServlet" method="post"
			style="display: inline;">
			<input type="hidden" name="advertisementNo"
				value="<%= store.getAdvertisement_No() %>" >
